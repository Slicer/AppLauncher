...
macro(ctkMacroBuildLib)
  ...
  # Wrap
  if(CTKAppLauncher_QT_VERSION VERSION_GREATER "5")
    set(CMAKE_AUTOUIC ON)
    set(CMAKE_AUTOMOC ON)
    set(CMAKE_AUTORCC ON)
    set(${prefix}_MOC_CXX ${${prefix}_MOC_SRCS})
    set(${prefix}_UI_CXX ${${prefix}_UI_FORMS})
    if(DEFINED ${prefix}_RESOURCES)
      set(${prefix}_QRC_SRCS ${${prefix}_RESOURCES})
    endif()
  else()
